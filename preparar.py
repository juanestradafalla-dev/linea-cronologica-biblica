...
# ni años de reinado. Las cuatro fechas GC conservan la atribución interpretativa.
...
families=json.loads((study/'genealogias-datos.json').read_text(encoding='utf-8'))['families']
text=text.replace('__FAMILIES__',str(len(families)))
